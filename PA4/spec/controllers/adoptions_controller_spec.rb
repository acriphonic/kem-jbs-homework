...
describe AdoptionsController do
  ...
  describe "GET index" do
    it "assigns all adoptions as @adoptions" do
      ...
      assigns(:adoptions).should eq([adoption])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested adoption as @adoption" do
      ...
      assigns(:adoption).should eq(adoption)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new adoption as @adoption" do
      ...
      assigns(:adoption).should be_a_new(Adoption)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created adoption as @adoption" do
        post :create, {:adoption => valid_attributes}, valid_session
        assigns(:adoption).should be_a(Adoption)
        assigns(:adoption).should be_persisted
      end

      it "redirects to the created adoption" do
        post :create, {:adoption => valid_attributes}, valid_session
        response.should redirect_to(Adoption.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved adoption as @adoption" do
        ...
        Adoption.any_instance.stub(:save).and_return(false)
        post :create, {:adoption => {}}, valid_session
        assigns(:adoption).should be_a_new(Adoption)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested adoption" do
        adoption = Adoption.create! valid_attributes
        # Assuming there are no other adoptions in the database, this
        # specifies that the Adoption created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Adoption.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => adoption.to_param, :adoption => {'these' => 'params'}}, valid_session
      end
      ...
      it "redirects to the adoption" do
        adoption = Adoption.create! valid_attributes
        put :update, {:id => adoption.to_param, :adoption => valid_attributes}, valid_session
        response.should redirect_to(adoption)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the adoption as @adoption" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Adoption.any_instance.stub(:save).and_return(false)
        put :update, {:id => adoption.to_param, :adoption => {}}, valid_session
        assigns(:adoption).should eq(adoption)
      end
